      ...
      <div className='flex items-center min-h-screen px-4 py-8'>
        ...
        <div className='max-w-sm mx-auto py-3 space-y-3 text-center'>
          ...
          <p className='text-[15px] text-gray-600'>
            Here we can specify the details of the receiver to start tracking, by default product ID assign is 0 for the first one 
          </p>
          <form onSubmit={(e) => e.preventDefault()}>
            ...
            {/* 2nd input */}
            <div className='relative mt-3'>
              <input type="date" placeholder='pickupTime' className='w-full pl-5 pr-3 py-2 text-gray-500 bg-transparent outline-none border focus:border-indigo-600 shadow-sm rounded-lg' onChange={(e) => setShipment({
                ...shipment,
